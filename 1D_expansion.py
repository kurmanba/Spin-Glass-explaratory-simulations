...
""""Puropse of the work is to understand symmetry of neighbor repositioning and
    see how rules based on nearest neighbors can be extended. A bit stubborn
    approach yet doesn't contradict canonical ensemble. What we want to see 
...
""" This piece of code distributes original set of neighbors equidistantly from 
    ...
    element.(center can be any point achived by circular shift)"""
